...
- MULTI AI AGENT 기반 자동 숏폼 제작 앱 서비스 [AI서버](https://github.com/swk5276/ko_storyagent_AI) [백엔드 서버](https://github.com/swk5276/ko_storyagent)
(TEAM PROJECT / 4 MEMBERS / 25.05 ~ 25.08)  
  <br/>&emsp; 다중 AI 에이전트를 활용하여 음성 → 텍스트 → 장면 추출 → 이미지/영상/음악 생성까지 자동화하는 스토리북 제작 파이프라인  
  <br/>&emsp; 주요 기능 : MULTI AGENT / STT 앙상블(Whisper), 텍스트 정제, 장면
...
- [ CNN 기반 다색상 원단 유사도 검출 시스템 ](https://github.com/inu-ese-capstone-design-team-YSN)  
  (TEAM PROJECT / 4 MEMBERS / 24.01 ~ 24.06)  
